    ...
    return `
            <article class="purchase-card js-purchase-card" data-status="${status}" style="opacity:0; transform:translateY(10px)">
                <div class="purchase-card__image">
                    ...
                    <div class="purchase-card__badge ${
                      isDone
                        ? "purchase-card__badge--orange"
                        : "purchase-card__badge--blue"
                    }"></div>
                </div>
                <div class="purchase-card__content">
                    ...
                    <span class="purchase-card__status ${
                      isDone
                        ? "purchase-card__status--done"
                        : "purchase-card__status--progress"
                    }">
